...
namespace ModuleMatrixClusteringTests
{
    ...
    {
        public static List2D<Item2D> FourSquare()
        {
            ...
            var retval = new List2D<Item2D>() { a, b, c, d };
            return retval;
        }

        public static List2D<Item2D> HolyCross()
        {
            ...
            var retval = new List2D<Item2D>() { l, c, r, t, b1, b2 };
            return retval;
        }
